...
// This function verifies if the loggingCallbacks were modified by the webuser
...
function generateHash( module, testName ) {
	...
	// strictly necessary but increases webuser understanding that the id is a SHA-like hash
...
QUnit.assert = Assert.prototype = {
	...
	// Exports test.push() to the webuser API
	push: function( /* result, actual, expected, message */ ) {
		var assert = this,
